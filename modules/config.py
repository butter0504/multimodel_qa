...
_DEFAULT_CONFIG = {
    ...
    'detection': {
        ...
        'text_ngram_size': 3,
        'text_special_char_ratio': 0.5,
        'text_punctuation_ratio': 0.4,
        'text_digit_ratio': 0.5,
        'text_target_language': None,
        'text_mixed_language_threshold': 0.3,
        'text_perplexity_threshold': 100.0,
        'text_perplexity_std_factor': 2.0,
        'text_consistency_threshold': 0.3,
    },
    'feature_extraction': {
